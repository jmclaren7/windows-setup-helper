...
_FileRegister("zip", '"' & $HelperHome & '\Tools\7-Zip\7zFM.exe" "%1"', "Open with 7-Zip", True, $HelperHome & "\Tools\7-Zip\7z.dll,-1", "Image File")
_FileRegister("7z", '"' & $HelperHome & '\Tools\7-Zip\7zFM.exe" "%1"', "Open with 7-Zip", True, $HelperHome & "\Tools\7-Zip\7z.dll,0", "Image File")
