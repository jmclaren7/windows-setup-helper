...
$cdmPath = "Registry::$DefaultUserHive\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"
$cdmValues = @{
...
$explorerPath = "Registry::$DefaultUserHive\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced"
$cdmValues = @{
...
$runPath = "Registry::$DefaultUserHive\Software\Microsoft\Windows\CurrentVersion\Run"
...
$cloudPath = "Registry::HKLM\Software\Policies\Microsoft\Windows\CloudContent"
