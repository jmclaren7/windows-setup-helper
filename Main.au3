...
Switch $Command
	...
	Case "main-gui", "boot-gui"
		...
		$GUIMain = GUICreate("$Title", 808, 552, -1, -1)
		...
		$Tab1 = GUICtrlCreateTab(7, 4, 793, 503)
		$MainTabSheet = GUICtrlCreateTabItem("&")
		$Group1 = GUICtrlCreateGroup("Scripts", 393, 33, 393, 460)
		$ScriptsTreeView = GUICtrlCreateTreeView(409, 57, 360, 390, BitOR($GUI_SS_DEFAULT_TREEVIEW,$TVS_CHECKBOXES))
		$RunButton = GUICtrlCreateButton("Run", 665, 457, 107, 25)
		...
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		$Group3 = GUICtrlCreateGroup("Create Local User", 22, 404, 361, 89)
		$CreateLocalUserButton = GUICtrlCreateButton("Create Local User", 235, 456, 131, 25)
		$UsernameInput = GUICtrlCreateInput("", 38, 426, 185, 21)
		$PasswordInput = GUICtrlCreateInput("", 38, 458, 185, 21)
		$AdminCheckBox = GUICtrlCreateCheckbox("Local Administrator", 238, 428, 113, 17)
		GUICtrlSetState(-1, $GUI_CHECKED)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		$Group4 = GUICtrlCreateGroup("Actions", 22, 294, 361, 105)
		...
		$Group5 = GUICtrlCreateGroup("WinPE Tools", 19, 37, 377, 460)
		$PERunButton = GUICtrlCreateButton("Run", 265, 462, 107, 25)
		$PEScriptTreeView = GUICtrlCreateTreeView(35, 85, 345, 369, BitOR($GUI_SS_DEFAULT_TREEVIEW,$TVS_CHECKBOXES))
		$Label3 = GUICtrlCreateLabel("Select scripts to run now in WinPE", 43, 61, 167, 17)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		$Group6 = GUICtrlCreateGroup("Install", 411, 37, 377, 460)
		$NormalInstallButton = GUICtrlCreateButton("Normal Install", 427, 462, 131, 25)
		$AutomatedInstallButton = GUICtrlCreateButton("Automated Install", 603, 462, 163, 25, $BS_DEFPUSHBUTTON)
		$PEInstallTreeView = GUICtrlCreateTreeView(428, 85, 345, 337, BitOR($GUI_SS_DEFAULT_TREEVIEW,$TVS_CHECKBOXES))
		$Label2 = GUICtrlCreateLabel("Select scripts to run after automated install", 436, 62, 203, 17)
		$PEComputerNameInput = GUICtrlCreateInput("", 596, 430, 169, 21)
		$Label4 = GUICtrlCreateLabel("Computer Name", 508, 433, 80, 17)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
