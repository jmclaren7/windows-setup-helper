...
- Folders on different drives matching the path convention are added:
  - X:\Helper\Tools
  - F:\Helper\Tools
...
This optional setting in Build.bat is a directory of files that are added to the WinPE image along with the project files. This allows you can keep your customizations separate from the project files to make updating easier.
